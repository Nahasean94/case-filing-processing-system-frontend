...
import {setLoginToken} from "../../actions/deputyRegistrarLoginActions"
import {connect} from 'react-redux'
import {fetchOptionsOverride} from "../../shared/fetchOverrideOptions"
import {deputyRegistrarLogin, courtStations} from '../../shared/queries'
import {Consumer, Query} from "graphql-react"
import Select from 'react-select'

let courtStationOptions

class DeputyRegistrarLogin extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            username: '',
            ...
            this.props.graphql
                .query({
                    ...
                    operation: {
                        ...
                        query: deputyRegistrarLogin
                    }
                })
                .request.then(({data}) => {

                    if (data.deputyRegistrarLogin.token === null || !data.deputyRegistrarLogin.ok) {
                        this.setState({errors: {form: data.deputyRegistrarLogin.error}, isLoading: false})
                    }
                    else {
...
DeputyRegistrarLogin.propTypes = {
    setLoginToken: PropTypes.func.isRequired,
}
DeputyRegistrarLogin.contextTypes = {
    router: PropTypes.object.isRequired
}
const exportLogin = ({setLoginToken}) => <Consumer>{graphql => <DeputyRegistrarLogin setLoginToken={setLoginToken}
